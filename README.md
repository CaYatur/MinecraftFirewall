...
Verified tables ship for **1.21 through 1.21.11** (protocols 767–774). On any other version:
...
The floor is 1.21 — Mojang's generator did not emit packet IDs before it, so older tables cannot be
produced this way and are not guessed.
